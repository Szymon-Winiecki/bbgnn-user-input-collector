...
export default function PhraseForm({ phrase, input, writing, disableInput, OnPhraseChange, OnInputChange, OnInputFocus, OnInputBlur, OnRandomPhraseClicked, OnKeyDown, OnKeyUp, OnSubmit, OnCancel }) {
  return (
