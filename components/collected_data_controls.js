...
export default function CollectedDataControls({ OnSendSelectedClick, OnRemoveSelectedClick, OnSendAllClick}) {
    ...
    return (
        <div className="col-10 offset-1 row g-2">
            <div className="col-6">
                <button className="btn btn-primary col-12" onClick={OnSendSelectedClick} disabled >Send selected</button>
            </div>
            <div className="col-6">
                <button className="btn btn-danger col-12" onClick={OnRemoveSelectedClick} disabled >remove selected</button>
            </div>
