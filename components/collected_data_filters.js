    ...
    return (
        <div className="col-10 offset-1 row g-2">
            ...
            <div className="input-group mb-3">
                ...
                <select className="form-select w-50" defaultValue="default">
            ...
            <div className="input-group mb-3">
                ...
                <select className="form-select" multiple defaultValue={["all"]}>
            ...
            <div className="input-group mb-3">
                ...
                <input type="text" list="phrases-list" className="form-control" />
